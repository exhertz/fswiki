...
::: tip ПРИМЕЧАНИЕ
**Вы можете удобрять каждую культуру дважды!**Удобрение не должно быть подряд, требуется пропустить одну стадию роста культуры или обработать поле другой техникой. Например, вы можете внести удобрение в первый раз после посева, а во второй - после того, как растения начнут прорастать. Но есть исключения:
...
::: tip СОВЕТ
Вы получите на 20% больше урожая, если ваш урожай будет очищен от сорняков или их не будет вовсе.
:::
